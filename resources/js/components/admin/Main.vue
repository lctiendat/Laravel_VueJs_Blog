<template>
  ...
  <html lang="en">
    ...
    <body id="page-top">
          ...
          <li class="nav-item">
            ...
            >
              <div class="bg-white py-2 collapse-inner rounded">
                ...
                <router-link class="collapse-item" tag="a" to="/panel/category"
                  >Category</router-link
                >
                <router-link class="collapse-item" tag="a" :to="{ name:'NewsTypeIndexAdmin' }"
                  >News Type</router-link
                >
                 <router-link class="collapse-item" tag="a" :to="{ name:'NewsIndexAdmin' }"
                  >News</router-link
                >
              </div>
            </div>
      ...
      <script type="application/javascript" src="/admin/js/sb-admin-2.min.js" />
    </body>
  </html>
</template>
